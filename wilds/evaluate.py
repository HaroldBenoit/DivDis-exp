...
from wilds import benchmark_datasets, get_dataset
...
def evaluate_benchmark(
    ...
    def get_replicates(dataset_name: str):
        ...
        for replicate in replicates:
            try:
                ...
                if dataset_name == "globalwheat":
                    metric_results: Dict[
                        str, float
                    ] = evaluate_replicate_for_globalwheat(
                ...
                print(f"Error while processing {replicate}!")
                print(e)
