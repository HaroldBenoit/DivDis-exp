...
import wilds
from algorithms.initializer import infer_d_out, initialize_algorithm
from configs.utils import populate_defaults
from models.initializer import initialize_model
from train import evaluate, infer_predictions, train
...
def main():
    ...
    parser.add_argument("--divdis_heads", type=int)
    parser.add_argument("--divdis_diversity_weight", type=float)

    parser.add_argument("--l_divdis_reconst_weight", type=float)
